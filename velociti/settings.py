"""
Django settings for velociti project.
...
SECRET_KEY = 'django-insecure-wp1zod6l&0%_1667c#)@!)adit-vm%!-s_o&f26kknd0++!2z+'
...
WSGI_APPLICATION = 'velociti.wsgi.application'
